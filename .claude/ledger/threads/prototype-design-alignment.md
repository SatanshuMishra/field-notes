...
- A stale `stash@{0}` ("WIP on feat/b4-rail-footer-state") holds only codegen churn that PR #67 has since superseded. Droppable, left in place because stash drops need confirmation.
