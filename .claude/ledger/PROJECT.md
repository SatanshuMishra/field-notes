...
## Threads
- journal-app-design — paused — 31/31 SHIPPED and now BUILDS + RUNS on macOS (Xcode 26.6 + CocoaPods 1.17.0 installed; `flutter build macos` OK; home screen visually confirmed against live data; 660/660 tests). Next phase: debug/troubleshoot, awaiting the user's specific instructions. See sessions/2026-07-21-05.
